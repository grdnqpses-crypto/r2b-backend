...
const ARTICLES: Article[] = [
  ...
  },
  {
    id: "deep-science",
    emoji: "🔬",
    title: "About the Science: Deep Dive",
    subtitle: "The published research behind belief field detection",
    content: [
      "This section explores the real, peer-reviewed scientific research that forms the foundation of the Belief Field Detector. Every claim in this app is grounded in documented phenomena.",
      "📚 THE PLACEBO EFFECT — Documented in thousands of clinical trials since Henry Beecher's landmark 1955 paper 'The Powerful Placebo' in the Journal of the American Medical Association. A 2001 meta-analysis in the New England Journal of Medicine confirmed that placebo responses produce measurable physiological changes including endorphin release, dopamine production, and immune system modulation. In 2005, researchers at the University of Michigan used PET scans to show that placebo beliefs trigger real opioid release in the brain — the same chemicals as actual painkillers.",
      "🧠 NEURAL IMAGERY & REALITY — A groundbreaking 1995 study by Alvaro Pascual-Leone at Harvard showed that people who merely imagined playing piano exercises developed the same brain map changes as those who physically practiced. Published in the Journal of Neurophysiology. In 2004, researchers at the University of Colorado used fMRI to show that imagined visual scenes activate the primary visual cortex — the brain literally 'sees' what you imagine.",
      "❤️ HEART COHERENCE — The HeartMath Institute has published over 300 peer-reviewed studies on heart-brain coherence. Their research, published in journals including the American Journal of Cardiology, shows that focused positive emotion creates a measurable electromagnetic signal from the heart that can be detected by magnetometers up to several feet away. Their 2004 study 'Electrophysiological Evidence of Intuition' showed that the heart responds to emotional stimuli before the brain consciously processes them.",
      "🧬 PSYCHONEUROIMMUNOLOGY — Robert Ader's pioneering work at the University of Rochester (published in Psychosomatic Medicine, 1975) proved that the immune system can be conditioned by belief and expectation. Subsequent research by Janice Kiecolt-Glaser at Ohio State University showed that positive beliefs and meditation measurably increase natural killer cell activity and wound healing speed.",
      "⚡ BIOELECTROMAGNETICS — The Bioelectromagnetics Society has documented that human bodies generate electromagnetic fields measurable with SQUID magnetometers. Research published in the Proceedings of the National Academy of Sciences shows that neural activity produces magnetic fields of 10-100 femtotesla. While phone magnetometers measure in microtesla (much less sensitive), they can detect environmental electromagnetic fluctuations influenced by nearby electronic and biological activity.",
      "🧘 MEDITATION & BRAIN CHANGES — Sara Lazar's 2005 study at Massachusetts General Hospital (published in NeuroReport) showed that meditation physically thickens the prefrontal cortex. Richard Davidson's research at the University of Wisconsin (published in PNAS, 2004) showed that experienced meditators produce gamma waves 30 times stronger than non-meditators — measurable electromagnetic changes in brain activity.",
      "👶 CHILDHOOD BELIEF & DEVELOPMENT — Jacqueline Woolley's research at the University of Texas (published in Child Development, 2006) showed that children who engage in magical thinking develop stronger executive function, creativity, and emotional regulation. Belief in figures like Santa Claus and the Tooth Fairy isn't just fun — it builds cognitive skills that serve children throughout their lives.",
      "🌊 THE OBSERVER EFFECT — While the quantum observer effect is often oversimplified, the Princeton Engineering Anomalies Research (PEAR) lab conducted 28 years of experiments (1979-2007) showing statistically significant correlations between human intention and random physical systems. Their results, published in the Journal of Scientific Exploration, showed small but consistent effects of consciousness on physical processes.",
      "📖 FURTHER READING — For those who want to explore deeper: 'The Biology of Belief' by Bruce Lipton (2005), 'Mind Over Medicine' by Lissa Rankin (2013), 'The Intention Experiment' by Lynne McTaggart (2007), and 'How God Changes Your Brain' by Andrew Newberg (2009) all provide accessible summaries of the research behind belief's physical effects.",
    ],
  },
  {
    id: "timer",
    emoji: "⏰",
    title: "The Belief Timer",
    subtitle: "How rest activates and strengthens your belief field",
    content: [
      "The Belief Timer is a powerful tool — especially for parents. After a scan, you can set a countdown that tracks the 'activation period' while your child rests. Here's the science behind why it works.",
      "😴 SLEEP & MEMORY CONSOLIDATION — Research published in Nature Neuroscience (2010) by Matthew Walker's lab at UC Berkeley showed that sleep strengthens neural connections formed during waking hours. When your child falls asleep after a belief scan, their brain is literally reinforcing the neural pathways of that belief. The timer tracks this consolidation period.",
      "🧠 EMOTIONAL MEMORY — The amygdala processes emotional memories during REM sleep. A 2011 study in Current Biology showed that sleep selectively strengthens emotional memories over neutral ones. Since belief is deeply emotional, sleep is the perfect time for belief fields to 'activate' — the brain prioritizes processing what matters most to you.",
      "🎯 FOR PARENTS — The timer gives children a concrete, scientific reason to stay in bed. 'Your belief field scored 87! Now set the timer — the magic activates while you sleep. If you get up, the activation pauses.' It transforms bedtime from a battle into an exciting experiment.",
      "⏱️ TIMER OPTIONS — 15 minutes (quick activation), 30 minutes (standard bedtime window), 1 hour (deep activation), or 2 hours (full dream cycle). Each option includes a progress bar and phase messages that describe what's happening as the magic activates.",
      "✨ COMPLETION — When the timer finishes, a celebration screen confirms that the belief field has been fully activated. The science note explains that sleep consolidated the neural pathways — making the belief stronger than before. It's a beautiful moment of wonder and accomplishment.",
    ],
  },
  {
    id: "parents",
