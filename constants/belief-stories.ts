/**
 * Belief Stories — Narrated immersive experiences that play during scans.
...
export const BELIEF_STORIES: BeliefStory[] = [
  {
    id: "story-santa",
    beliefId: "santa",
    ...
    segments: [
      ...
      { startAt: 0.65, text: "Across the world, millions of children are believing right now, just like you. That belief creates a field of energy that stretches across the sky.", rate: 0.8 },
      { startAt: 0.8, text: "Santa is getting closer. Your belief is pulling him toward you. The stronger you believe, the brighter the path.", rate: 0.85 },
      { startAt: 0.92, text: "Your belief field is powerful. Keep believing.", rate: 0.8, pitch: 0.95 },
    ],
  },
  {
    id: "story-tooth-fairy",
    beliefId: "tooth-fairy",
    title: "The Fairy's Visit",
    description: "A gentle story about the Tooth Fairy sensing your belief from far away",
    segments: [
      { startAt: 0.0, text: "Take a deep breath. Somewhere, in a realm of sparkle and light, the Tooth Fairy is listening.", rate: 0.85 },
      { startAt: 0.12, text: "She has tiny wings that shimmer like diamonds, and she can feel the belief of every child in the world.", rate: 0.85 },
      { startAt: 0.25, text: "Right now, she feels yours. Your belief is like a warm glow that she can see from miles away.", rate: 0.85 },
      ...
      { startAt: 0.55, text: "The sensors in your phone are picking up the same energy she feels. Your belief is creating ripples in the air around you.", rate: 0.85 },
      { startAt: 0.7, text: "She's smiling right now. She can feel how strongly you believe. It makes her wings glow even brighter.", rate: 0.85 },
      { startAt: 0.85, text: "Keep believing. The Tooth Fairy never forgets a true believer.", rate: 0.8, pitch: 0.95 },
    ],
  },
  {
    id: "story-easter-bunny",
    beliefId: "easter-bunny",
    ...
    segments: [
      ...
      { startAt: 0.3, text: "The Easter Bunny is painting eggs right now. Each one is a tiny masterpiece, made with love for a child who believes.", rate: 0.85 },
      { startAt: 0.45, text: "One of those eggs has your name on it. The Bunny paints it with the colors of your belief — and right now, those colors are glowing.", rate: 0.85 },
      { startAt: 0.6, text: "Your phone's sensors can feel the energy of your belief reaching out toward that hidden garden. The field is growing.", rate: 0.85 },
      { startAt: 0.75, text: "The Easter Bunny pauses and looks up. He can feel you believing. His whiskers twitch with joy.", rate: 0.85 },
      { startAt: 0.9, text: "Your belief is strong. The egg is almost finished. Keep believing.", rate: 0.8, pitch: 0.95 },
    ],
  },
  {
    id: "story-god",
    ...
    segments: [
      ...
      { startAt: 0.85, text: "Stay in this moment. Your belief is powerful. It always has been.", rate: 0.75, pitch: 0.9 },
    ],
  },
  {
    id: "story-guardian-angels",
    beliefId: "guardian-angels",
    ...
    segments: [
      ...
      { startAt: 0.45, text: "When you believe in them, they draw closer. Your belief is like a light that strengthens their presence.", rate: 0.85 },
  ...
  },
  {
    ...
    segments: [
      ...
      { startAt: 0.25, text: "When you believe in yourself, that energy changes. It gets stronger. More focused. More powerful.", rate: 0.85 },
      { startAt: 0.4, text: "Athletes know this. Before every great performance, there's a moment of belief — a moment where they know they can do it. And that belief makes it real.", rate: 0.85 },
      { startAt: 0.55, text: "Your phone's sensors are measuring your energy right now. The more you believe in yourself, the stronger the readings become.", rate: 0.85 },
      { startAt: 0.7, text: "You are capable of extraordinary things. Not because someone told you so, but because the science proves it. Your belief creates your reality.", rate: 0.85 },
      { startAt: 0.85, text: "Remember this feeling. You are powerful. You always have been.", rate: 0.8, pitch: 0.95 },
    ],
  },
];

export function getStoryForBelief(beliefId: string): BeliefStory | null {
  return BELIEF_STORIES.find((s) => s.beliefId === beliefId) || null;
}

export function getAvailableStoryBeliefIds(): string[] {
  return BELIEF_STORIES.map((s) => s.beliefId);
}
