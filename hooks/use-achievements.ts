...
const ACHIEVEMENTS_KEY = "@belief_achievements";
...
export const ALL_ACHIEVEMENTS: Achievement[] = [
  ...
  // EXPLORER — Trying different beliefs
  {
    id: "open-heart",
    title: "Open Heart",
    description: "You've explored 3 different beliefs. An open mind leads to deeper understanding.",
    howToEarn: "Scan 3 different beliefs",
    icon: "💖",
  ...
  },
  {
    ...
    description: "5 different beliefs scanned. You're exploring the full spectrum of human belief.",
    howToEarn: "Scan 5 different beliefs",
    icon: "🌍",
  ...
  },
  {
    ...
    description: "10 different beliefs! You understand that belief comes in many beautiful forms.",
    howToEarn: "Scan 10 different beliefs",
    icon: "🗺️",
  ...
  },
  {
    ...
    description: "You completed a guided meditation before your scan. A calm mind believes deeper.",
...
export const ACHIEVEMENT_CATEGORIES = [
  ...
  { id: "explorer" as const, name: "Explorer", emoji: "🌍", description: "Exploring different beliefs" },
...
export function useAchievements() {
  ...
  const checkAchievements = useCallback(
    async (stats: {
      ...
      if (stats.totalScans >= 50) toEarn.push("master-believer");
      ...
      // Explorer
      if (stats.uniqueBeliefs.length >= 3) toEarn.push("open-heart");
      if (stats.uniqueBeliefs.length >= 5) toEarn.push("world-explorer");
      if (stats.uniqueBeliefs.length >= 10) toEarn.push("belief-collector");
